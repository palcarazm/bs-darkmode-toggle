   ...
   */
    loadEnvData() {
        $.getJSON(
            PageModel.#package,
            function (data) {
                this.bootstrapVersion = data.packages["node_modules/bootstrap"].version;
                this.bsToggleVersion = data.packages["node_modules/bootstrap5-toggle"].version;
                this.jqueryVersion = data.packages["node_modules/jquery"].version;
                this.bsDarkmodeToggleVersion =data.version;
                this.#printEnvData();
            }.bind(this)
        );
    }
