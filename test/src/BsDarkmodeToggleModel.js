class BsDarkmodeToggleModel {
  ...
  static checkLightLabel($element, options = {}) {
    let $toggleOn = $element.find(".toggle > .toggle-group > .toggle-on");
  ...
  static checkDarkLabel($element, options = {}) {
    let $toggleOff = $element.find(".toggle > .toggle-group > .toggle-off");
...
export { BsDarkmodeToggleModel as default };
